  ...
  return (
    <main className="min-h-screen lg:grid lg:grid-cols-[minmax(14rem,18rem)_1fr]">
      <section className="flex flex-col border-b border-zinc-200 px-6 py-12 sm:px-10 lg:border-b-0 lg:border-r lg:px-16 lg:py-16">
        ...
        <h1 className="mt-6 font-display text-lg tracking-tight text-zinc-900">
          {category}
        </h1>
        ...
        <a
          ...
          className="font-display text-lg tracking-tight text-zinc-600 underline-offset-4 hover:text-zinc-900 hover:underline"
        >
          github
        </a>
      </section>
